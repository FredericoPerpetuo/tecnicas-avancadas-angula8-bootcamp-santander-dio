...
export class CadastroFilmesComponent implements OnInit {
    ...
    () => {
      const config ={
        data:{
          ...
          descricao: 'Não foi possível salvar o registro, tente mais tarde.',
          corBtnSucesso: 'warn',
          btnSucesso: 'Fechar',
        } as Alerta
      };
  ...
  private editar(filme: Filme): void{
    ...
    () => {
      const config ={
        data:{
          titulo: "Erroao editar o registro!",
          descricao: 'Não foi possível editar o registro, tente mais tarde.',
          corBtnSucesso: 'warn',
          btnSucesso: 'Fechar',
        } as Alerta
      };
